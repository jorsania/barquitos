...
if (!isset($_GET['token'])) {
    ...
    $respuesta->mensaje = "Hay que proporcionar el token asociado a la recuperación de cuenta";
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    // Si es una solicitud POST el cliente quiere completar el proceso de recuperación
    ...
    $respuesta->exito = true;
    $respuesta->mensaje = "El proceso de recuperación se ha completado con éxito";
    die(json_encode($respuesta));
}
